...
class base_testcase extends \block_completion_progress\tests\testcase {
    ...
    public function test_overview_options() {
        ...
        $table = new \block_completion_progress\table\overview($progress, [], 0, false);
        ...
        $this->assertStringNotContainsString('/user/profile.php?id='.$this->students[3]->id, $text);
        ...
        $this->assertStringContainsString('/user/profile.php?id='.$this->students[3]->id, $text);
    ...
    public function test_overview_percentage_sort() {
        ...
        $student0pos = strpos($text, '/user/profile.php?id='.$this->students[0]->id);
        $student1pos = strpos($text, '/user/profile.php?id='.$this->students[1]->id);
        $student2pos = strpos($text, '/user/profile.php?id='.$this->students[2]->id);
